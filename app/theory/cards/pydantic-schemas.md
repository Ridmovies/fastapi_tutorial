...
- Обязателен: если валидируешь ORM объект напрямую через Pydantic (model_validate) или есть вложенные ORM объекты / computed fields.

- Не обязателен: если просто отдаёшь ORM объект через FastAPI с response_model и все поля простые, без сложных вложенных объектов и property.

- Лучше ставить всегда, чтобы не ловить неожиданные ошибки при расширении проекта.
